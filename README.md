...
![Pydantic](https://img.shields.io/badge/Pydantic-Bounded%20Contracts-E92063?logo=pydantic&logoColor=white)
...
![Educational Use](https://img.shields.io/badge/Use-Educational%20Demo-blue)
![Not Medical Advice](https://img.shields.io/badge/Medical%20Use-Not%20Medical%20Advice-critical)
![No PHI](https://img.shields.io/badge/Data%20Safety-No%20PHI-success)
![Synthetic Profiles](https://img.shields.io/badge/Profiles-Fictional%20Examples-success)
![Deterministic Engine](https://img.shields.io/badge/Risk%20Engine-Deterministic%20Indicator-blueviolet)
![Explainability](https://img.shields.io/badge/Explainability-Threshold%20Contributors-orange)
![Input Validation](https://img.shields.io/badge/Validation-Bounded%20Inputs-success)
![Unknown Field Rejection](https://img.shields.io/badge/API-Rejects%20Unknown%20Fields-success)
![Blood Pressure Validation](https://img.shields.io/badge/Validation-BP%20Ordering-success)
![Artifact Independent](https://img.shields.io/badge/Demo-Artifact%20Independent-success)
![No API Key Required](https://img.shields.io/badge/Demo-No%20API%20Key%20Required-success)
![No External LLM](https://img.shields.io/badge/LLM-No%20External%20Runtime-lightgrey)
![API Health](https://img.shields.io/badge/API-Health%20Endpoint-success)
![Metrics Endpoint](https://img.shields.io/badge/API-Prometheus%20Metrics-success)
![Examples Endpoint](https://img.shields.io/badge/API-Fictional%20Examples-success)
...
![Syntax Validation](https://img.shields.io/badge/Python-Syntax%20Validated-3776AB)
![API Contract Tests](https://img.shields.io/badge/API-Contract%20Tests-success)
![Domain Tests](https://img.shields.io/badge/Domain-Risk%20Engine%20Tests-success)
![Supervisor Tests](https://img.shields.io/badge/Supervisor-Safety%20Tests-success)
![Streamlit Smoke Test](https://img.shields.io/badge/Streamlit-Smoke%20Tested-success)
...
![Python Runtime](https://img.shields.io/badge/Runtime-Python%203.11-blue)
...
![SBOM Provenance](https://img.shields.io/badge/Release-SBOM%20%26%20Provenance-success)
...
![Bandit](https://img.shields.io/badge/Bandit-Python%20Security-yellow)
![Trivy](https://img.shields.io/badge/Trivy-FS%20%26%20Container%20Reports-1904DA?logo=aqua&logoColor=white)
...
![CycloneDX](https://img.shields.io/badge/SBOM-CycloneDX-2D9CDB)
![Supply Chain](https://img.shields.io/badge/Supply%20Chain-Automated%20Verification-success)
![Security Policy](https://img.shields.io/badge/Security-Responsible%20Disclosure-success)
![Secrets Protected](https://img.shields.io/badge/Secrets-Gitignored%20%26%20Scanned-success)
...
![Supply Chain Hygiene](https://img.shields.io/badge/Tier%205-Supply--Chain%20Hygiene-blue)
...
[![License](https://img.shields.io/github/license/CoreyLeath-code/Disease_Prediction_Capstone)](https://github.com/CoreyLeath-code/Disease_Prediction_Capstone/blob/main/LICENSE)
![Last Commit](https://img.shields.io/github/last-commit/CoreyLeath-code/Disease_Prediction_Capstone)
![Repo Size](https://img.shields.io/github/repo-size/CoreyLeath-code/Disease_Prediction_Capstone)
![Code Size](https://img.shields.io/github/languages/code-size/CoreyLeath-code/Disease_Prediction_Capstone)
![Top Language](https://img.shields.io/github/languages/top/CoreyLeath-code/Disease_Prediction_Capstone)
![Issues](https://img.shields.io/github/issues/CoreyLeath-code/Disease_Prediction_Capstone)
![Pull Requests](https://img.shields.io/github/issues-pr/CoreyLeath-code/Disease_Prediction_Capstone)
![Contributors](https://img.shields.io/github/contributors/CoreyLeath-code/Disease_Prediction_Capstone)
![Stars](https://img.shields.io/github/stars/CoreyLeath-code/Disease_Prediction_Capstone?style=social)
![Forks](https://img.shields.io/github/forks/CoreyLeath-code/Disease_Prediction_Capstone?style=social)
---

> [!WARNING]
> **Educational portfolio demonstration only.** This repository is not a medical device, has not been clinically validated, and must not be used to diagnose, treat, triage, or make patient-care decisions. Use only fictional, synthetic, or fully non-identifiable values. Do not enter protected health information (PHI).
